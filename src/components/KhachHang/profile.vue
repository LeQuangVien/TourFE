            ...
            <div class="row">
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <img src="https://cdn3.ivivu.com/2022/09/T%E1%BB%95ng-quan-du-l%E1%BB%8Bch-V%C5%A9ng-T%C3%A0u-ivivu.jpg"
                                    ...
                                    <div class="car-body">
                                        <div class="d-flex flex-column align-items-center text-center">
                                            <img src="https://image.pngaaa.com/345/1582345-middle.png" alt=""
                                                class="rounded-circle p-1 bg-danger" width="150px">
                                            <div class="mt-3">
                                                <h4></h4>
                                ...
                                <tbody>
                                    <template v-for="(value, index) in data_order" :key="index">
                                        <tr>
                                            ...
                                            <td><button disabled v-if="value.tinh_trang_ve == 0"
                                                    class="btn btn-primary me-1">
                                                    Đang Kiểm Tra
                                                </button>
                                                <button disabled v-if="value.tinh_trang_ve == 2"
                                                    class="btn btn-warning me-1">
                                                    Đã Duyệt
                                                </button>
                                                <button disabled v-if="value.tinh_trang_ve == 3"
                                            ...
                                            <td>{{ value.dia_chi_khach_hang }}</td>
                                        </tr>
                                    </template>
                                </tbody>
                            </table>
